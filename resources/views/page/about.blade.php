...
<!--==================================================-->
<section class="about_area style_four">
	<div class="container">
		<div class="row align-items-center">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						<div class="about_thumb">
							<img src="assets/images/inner-img/about_thumb.png" alt="">							
						</div>
					</div>
					<div class="col-lg-6 col-md-6">
						<div class="about_count style_two">					
							<h1 class="years_namber">22 <span>Years</span></h1>							
							<div class="counter_title">
								<h5>Experience</h5>
							</div>
						</div>
						<div class="about_thumb">
							<img src="assets/images/inner-img/about2.png" alt="">							
						</div>						
					</div>
				</div>
			</div>
			<div class="col-lg-6 col-md-12">
				<div class="about_right">
					<div class="section_title pb-16">
						<h1>Welcome to Our Poultry And <br>Egg Farm.</h1>
					</div>
					<div class="about_content">
						<p>Continually productize compelling quality for packed with Elated
							productize compelling quality for packed with all Elated ThemSetting
							up to website and creating pages.</p>
	
						<ul class="about_list">
							<li><i class="bi bi-check2"></i>We are providing different services</li>
							<li><i class="bi bi-check2"></i>We are one of leading company</li>
							<li><i class="bi bi-check2"></i>Profitability is the primary goal of all business</li>
							<li><i class="bi bi-check2"></i>Learn how to grow your Business</li>
						</ul>
						<div class="about_button">
							<div class="about_btn buddy_btn">
								<a href="about.html">Larn More  <i class="flaticon flaticon-right-arrow"></i><span></span></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-12">
				...
				<div class="video__area">
					...
					<a class="video-vemo-icon venobox vbox-item" data-vbtype="youtube" data-autoplay="true"
						href="https://youtu.be/BS4TUd7FJSg"><span class="play-now">play</span></a>
					</div>
				</div>
				<!-- Video Area End -->
			</div>
...
<section class="team_area style_two">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="section_title pb-50 text-center style_four style_five">
		...
		<div class="row">
			<div class="col-lg-3 col-md-6">
				<div class="single_team_item style_two">
					<div class="team_thumb">
						<img src="assets/images/inner-img/team1.png" alt="">
			...
			<div class="col-lg-3 col-md-6">
				<div class="single_team_item style_two">
					<div class="team_thumb">
						<img src="assets/images/inner-img/team2.png" alt="">
						<ul class="team_social_icon">
							<li><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
							<li><a href="#"><i class="fab fa-pinterest-p"></i></a></li>
							<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
			...
			<div class="col-lg-3 col-md-6">
				<div class="single_team_item style_two">
					<div class="team_thumb">
						<img src="assets/images/inner-img/team3.png" alt="">
						<ul class="team_social_icon">
							<li><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
							<li><a href="#"><i class="fab fa-pinterest-p"></i></a></li>
							<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
			...
			<div class="col-lg-3 col-md-6">
				<div class="single_team_item style_two">
					<div class="team_thumb">
						<img src="assets/images/inner-img/team4.png" alt="">
						<ul class="team_social_icon">
							<li><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
							<li><a href="#"><i class="fab fa-pinterest-p"></i></a></li>
							<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
