			...
			<div class="col-lg-12">
				<div class="breadcumb-content text-center">
					...
					<ul>
						...
						<li class="rotates"><i class="bi bi-slash-lg"></i>History</li>
					</ul>
				</div>
			</div>
		</div>
...
<section class="history_area">
	<div class="container">
			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-12">
					<div class="history_content">
						<h2>1950 BUILT IN</h2>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla hendrerit
							ut tortor egestas commodo. Fusce aliquet, sapien quis placerat varius,
							mi ex elit quam non dolor. Sed vel lectus orci. Aliquam ut massa tinci
							dunt, auctor enim eget, imnuc vivid dolore sit.</p>
						<div class="buddy_btn_home_three buddy_btn">
							<a href="service-details.html">View more<span style="top: 241.219px; left: 156.5px;"></span><i class="flaticon flaticon-right-arrow"></i></a>
						</div>
					</div>
				</div>
				<div class="col-lg-6 col-md-12">
					<div class="history_thumb style_first">
						<img src="assets/images/inner-img/history1.png" alt="">
					</div>
				</div>
			</div>
		</div>
		<div class="history_container">
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-12">
					<div class="history_thumb">
						<img src="assets/images/inner-img/history2.png" alt="">
					</div>
				</div>
				<div class="col-lg-6 col-md-12">
					<div class="history_content">
