		...
		<div class="row align-items-center">
			<div class="col-lg-6">
				<div class="contact_content">
					<h1>FARM CONTACT</h1>
					<p>Lorem ipsum dolor sit amet, ad nec scripta volumus, eu viris salutatus
						dissentias sit, ex enim duo magna nostro. Dolor sit amet, ad nec scripta
						volumus amet in sit vivid.</p>
				</div>
				<div class="contact_infoss">
					<p>Call Us</p>
					<h3>+ 12 0235 259 786</h3>
				...
				<div class="contact-form-box style_two">
					<form action="https://formspree.io/f/myyleorq" method="POST">
						<div class="row">
							...
							<div class="col-lg-12">
								<div class="form-box">
									<input type="email" name="name" placeholder="Gmail">
								</div>
							</div>						
